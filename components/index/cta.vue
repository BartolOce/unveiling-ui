<template>
  <div class="bg-white">
    <div class="mx-auto max-w-full pt-20 px-4 sm:px-6 lg:px-40">
      <div
        class="overflow-hidden rounded-lg bg-cyan-700 shadow-xl lg:grid lg:grid-cols-2 lg:gap-4"
      >
        <div
        ...
        >
          <div class="lg:self-center">
            ...
            <a
              href="#"
              class="mt-8 inline-flex items-center rounded-md border border-transparent bg-white px-5 py-3 text-base font-medium text-cyan-600 shadow hover:bg-indigo-50"
              >Sign up for free</a
            >
          </div>
        </div>
