  ...
  <div class="relative bg-white py-16 sm:py-24">
    ...
    >
      <div class="relative sm:py-16 lg:py-0">
        ...
        >
          <div
            class="absolute inset-y-0 right-1/2 w-full rounded-r-3xl bg-gray-100 lg:right-72"
          />
          <svg
        ...
        >
          ...
          >
            ...
            <div
              class="absolute inset-0 bg-gradient-to-t from-cyan-600 via-cyan-600 opacity-90"
            />
            <div class="relative px-8">
              <blockquote class="mt-8">
                ...
                >
                  <svg
                    class="absolute top-0 left-0 h-8 w-8 -translate-x-3 -translate-y-2 transform text-cyan-400"
                    fill="currentColor"
                    viewBox="0 0 32 32"
                    aria-hidden="true"
                  >
                ...
                <footer class="mt-4">
                  <p class="text-base font-semibold text-cyan-200">
...
<script setup>
const stats = [
  { label: "Lorem ", value: "2021" },
  { label: " ipsum ", value: "5" },
  { label: "dolor ", value: "521" },
  { label: " sit amet", value: "$25M" },
];
</script>
