<template>
  <section aria-labelledby="quick-links-title">
    <div
      class="border-cyan-700 border-2 divide-y divide-gray-200 overflow-hidden rounded-lg bg-gray-200 shadow sm:grid sm:grid-cols-2 sm:gap-px sm:divide-y-0"
    >
